...
class DataProcessor:
    ...
    def __init__(self, train_path, test_path, processed_dir, config_path):
        ...
        # we want to read file that is passed to config path
    ...
    def preprocess_data(self,df):
        try:
            ...
            # define all the categorical & numerical columns that u will extract from the yaml file
   ...
   # will take data from above pre processed step
    ...
    ### our data is processed now we just need to save it for our training purpose 
...
# just as in data ingestion we combined all our steps under function run
#     #  here we are combining all our steps under process function
    def process(self):
        try:
